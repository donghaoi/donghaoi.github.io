...
// 添加检查以确保 'window' 和 'windowItr.document.body' 存在
for (let windowItr = window; windowItr.parent !== windowItr && windowItr.document && windowItr.document.body; windowItr = windowItr.parent) {
  windowItr.document.body.addEventListener('keydown', onkeydown);
}

// 添加检查以确保 'window.top.document.body' 存在
